let bmiHistory = [];
let caloriesBurnedHistory = [];
let caloriesConsumedHistory = [];
...
function addActivity() {
    ...
    if (activity && duration) {
        ...
        caloriesBurnedHistory.push(totalCaloriesBurned);
        updateProgressChart();
    }
}
...
function addFoodItem() {
    ...
    if (foodItem && calories) {
        ...
        caloriesConsumedHistory.push(totalCaloriesConsumed);
        updateProgressChart();
    }
}
...
function updateProgressChart() {
    ...
    progressChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: Array.from({length: Math.max(bmiHistory.length, caloriesBurnedHistory.length, caloriesConsumedHistory.length)}, (_, i) => i + 1),
            datasets: [{
                label: 'BMI',
                data: bmiHistory,
                ...
                data: caloriesBurnedHistory,
                borderColor: 'rgb(255, 99, 132)',
                tension: 0.1
            }, {
                label: 'Calories Consumed',
                data: caloriesConsumedHistory,
